...
w_30085 = 0.0029/(5.5*10**9*np.exp(-6876/300.85))       #mittlere freie Weglänge bei einer Temp von 300,85 Kelvin
w_42415 = 0.0029/(5.5*10**9*np.exp(-6876/424.15))       #mittlere freie Weglänge bei einer Temp von 425,15 Kelvin
w_44315 = 0.0029/(5.5*10**9*np.exp(-6876/443.15))       #mittlere freie Weglänge bei einer Temp von 443,15 Kelvin
w_47025 = 0.0029/(5.5*10**9*np.exp(-6876/470.25))       #mittlere freie Weglänge bei einer Temp von 470,25 Kelvin
...
U_Skala1 = (np.sum(1/x_Skala1)/len(x_Skala1))              #Volt pro Kästchen
U_Skala2 = (np.sum(1/x_Skala2)/len(x_Skala2))              #Volt pro Kästchen
...
plt.ylabel(r"|$\propto \frac{\Delta I}{\Delta U}$|")
plt.legend(loc = "best")
...
print(f""" 
Volt pro Kästchen 300,85K: {U_Skala1}
Volt pro Kästchen 424,15K: {U_Skala2}
""")
